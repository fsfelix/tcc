...
**** DONE [#B] Lecture 3 - The Linear Model I
**** TODO Lecture 4 - Error and Noise
**** TODO [#A] Lecture 5 - Training vs Testing
...
** Tarefas
*** TODO Implementar protótipo simples para entender scikit.
**** TODO kNN
**** TODO Naïve-Bayes
*** TODO Preparar apresentação com protótipo e explicação.
*** TODO Entender SVM e implementar com scikit.
