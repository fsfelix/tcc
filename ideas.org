...
***** TODO Sons de pássaros
***** TODO Classificação multi-classes
**** TODO Extração de características
***** TODO Características acústicas
***** TODO Características próprias do domínio
***** TODO Características globais
**** TODO Classificação
***** TODO Aprendizagem supervisionada
