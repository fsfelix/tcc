...
if ~isstr(fun),
  ...
  % Init figure
  hf = figure('name','Kmeans Explorer','numbertitle','off');
...
%      end;
      ...
      assignin('base','kmeans_result_means',mmeans);
      assignin('base','kmeans_result_vars',vvars);
      assignin('base','kmeans_result_priors',ppriors);
      disp(' ');
      disp([ 'KMEANS: resulting means, variances and priors are now stored in' ...
	    ' the workspace variables kmeans_result_means,' ...
	    ' kmeans_result_vars and kmeans_result_priors.' ]);
